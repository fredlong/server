...
import net.xiaoxiang.server.binarystack.entity.Callback;
...
/**
 * 回调函数管理类
 * 服务器端在发送通知类请求后，将回调函数和请求都放入到本类中进行管理，待应答回来后，Dispatch类会调用本类执行回调函数
