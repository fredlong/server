...
public class BeanResourceManager {
     ...
     * Handler初始化时可能抛出本错误
     */
    public static void addHandlerBean(Short cmd , Class notifyHandlerClazz , Class notifyRequestClazz) throws InstantiationException, IllegalAccessException{
     ...
     * Handler初始化时可能抛出本错误
     */
    public static void addNotifyBean(Short cmd , Type responseType){
