package net.xiaoxiang.server.binarystack.entity;
...
public class CommonResponse<T> {
    ...
    public CommonResponse(ResponseInformation responseInformation){
        this(responseInformation.resultCode , responseInformation.message , null);
    }

    public CommonResponse(ResponseInformation responseInformation  , T entity){
        this(responseInformation.resultCode , responseInformation.message , entity);
    }
